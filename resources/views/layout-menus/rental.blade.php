            ...
            <div class="card-body p-4 d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="fw-semibold mb-1">
                        <i class="fas fa-boxes me-2"></i>Rental Unit Dashboard
                    </h5>
        ...
        <div class="feature-sections">
            ...
            <div class="section-card mb-5">
                <div class="section-header">
                    <i class="fas fa-warehouse me-2"></i>Rental Unit
                </div>
                <div class="section-body row g-3 px-3 pb-3 pt-2">

                    {{-- Warehouse List --}}
                    <div class="col-6 col-md-3">
                        <div class="feature-card" data-href="{{ route('master_regions.index') }}">
                            <div class="icon bg-1"><i class="fas fa-warehouse"></i></div>
                            <p class="title">Region Apart</p>
                        </div>
                    </div>

                    {{-- Inventory Items --}}
                    <div class="col-6 col-md-3">
                        <div class="feature-card" data-href="{{ route('master_units.index') }}">
                            <div class="icon bg-2"><i class="fas fa-boxes"></i></div>
                            <p class="title">Data Unit</p>
                        </div>
                    </div>

                    {{-- Warehouse Items --}}
                    <div class="col-6 col-md-3">
                        <div class="feature-card" data-href="{{ route('master_unit_sewas.index') }}">
                            <div class="icon bg-3"><i class="fas fa-cubes"></i></div>
                            <p class="title">Data Rental Unit</p>
                        </div>
                    </div>

                    {{-- Warehouse Item Mutation --}}
                    <div class="col-6 col-md-3">
                        <div class="feature-card" data-href="{{ route('master_unit_hutangs.index') }}">
                            <div class="icon bg-4"><i class="fas fa-exchange-alt"></i></div>
                            <p class="title">Data Hutang Rantal Unit</p>
                        </div>
                    </div>
                </div>
            </div>
