...
return new class extends Migration {
    ...
    {
        Schema::create('master_cs_sewas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('agen_id')->constrained('master_agens')->onDelete('cascade');
            $table->foreignId('customer_id')->constrained('master_customers')->onDelete('cascade');
            ...
            $table->bigInteger('biaya_jual_unit')->default(0);
    ...
    {
        Schema::dropIfExists('master_cs_sewas');
    }
};
